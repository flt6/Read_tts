...
# cookie_phpdisk_info = "AjJWbQFmBjJTYANkAVJSPAFYBGBcaVZkVTpSZwUKCmxXMVUxUjgAOQRiUjcNY1I4UjRQNg81ADICMQluAzQEPwIyVjcBMQY8UzMDagE/UjEBNQQ3XDdWZFUzUjUFOwoBV2JVYlI4ADUEPlIzDW9SPlIwUGEPYQ=="
# Cookie 中 ylogin 的值
cookie_ylogin = os.environ.get('ylogin')
# cookie_ylogin = "495817"
...
if __name__ == '__main__':
    ...
    # 需上传的路径
    upload_path = "main.exe" # argv[0]
    # 蓝奏云文件夹id
    lzy_folder_id = 3714834
    if login_by_cookie():
